...
public class ManagerTest {
    ...
    @Test
    public void Give1Manager1EmptyParkingLotAnd1SmartBoy1EmptyParkingWhenParkingThenGetParkingLot2sTicket(){
        Manager manager=new  Manager();
        ParkLot parkLot1=new ParkLot(1,"001");
        manager.addParkLot(parkLot1);
    ...
    @Test
    public void Give1Manager1EmptyParkingLotAnd1SmartBoy1EmptyParkingAnd1ParkingBoy0SlotParkingWhenParkingThenGetParkingLot2sTicket(){
        Manager manager=new  Manager();
        ParkLot parkLot1=new ParkLot(1,"001");
        manager.addParkLot(parkLot1);
    ...
    @Test
    public void Give1Manager1EmptyParkingLotAnd1SmartBoy0SlotParkingAnd1ParkingBoy1EmptyParkingWhenParkingThenGetParkingLot2sTicket(){
        Manager manager=new  Manager();
        ParkLot parkLot1=new ParkLot(1,"001");
        manager.addParkLot(parkLot1);
        ...
        Assert.assertNotNull(ticket);
        Assert.assertEquals(ticket.getCarNumber(), "C001");
        Assert.assertEquals(ticket.getParkLot(), parkLot1);

    }

    @Test
    public void Give1Manager0SlotParkingLotAnd1SmartBoy0SlotParkingAnd1ParkingBoy1EmptyParkingWhenParkingThenGetParkingLot2sTicket(){
        Manager manager=new  Manager();
        ParkLot parkLot1=new ParkLot(1,"001");
        parkLot1.park(new Car("X001"));
        manager.addParkLot(parkLot1);
